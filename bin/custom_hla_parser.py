...
if __name__ == "__main__":
    ...
    usage = __doc__.split("\n\n\n")
    parser = argparse.ArgumentParser(description="Parse custom HLA list")

    parser.add_argument("--custom_list", required=False, help="HLAs custom list input")
    parser.add_argument(
